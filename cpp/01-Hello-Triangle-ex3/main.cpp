...
const char *vertexShaderSource = "#version 330 core\n"
    ...
    "}\0";
const char *const fragmentShaderSource[2] {
    "#version 330 core\n"
    "out vec4 FragColor;\n"
    "void main()\n"
    "{\n"
...
int main()
{
    ...
    for (int i = 0; i < 2; i++) {
        ...
        glShaderSource(fragmentShader, 1, &fragmentShaderSource[i], length);
        ...
        // link shaders
        unsigned int &shaderProgram_ = shaderProgram[i];
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(float) * 3 * 3, vertices + 3 * 2, GL_STATIC_DRAW);
